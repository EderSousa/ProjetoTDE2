...
import logo from "@/src/assets/cep-1.png"
  ...
  return (
    <View style={styles.container}>
      <View style={styles.boxtop}>
        ...
        <Text style={styles.txttop}>Procure seu CEP</Text>
      </View>

      <View style={styles.boxmid}>
        <Text style={styles.txtimpp}>Informe seu CEP: Apénas Números</Text>
        <TextInput
          style={styles.impt}
      ...
      <View style={styles.button}>
        <TouchableOpacity style={styles.btt} onPress={handlePress}>
          <Text>Clique e veja sua Rua</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
